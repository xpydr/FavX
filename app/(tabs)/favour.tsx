...
export default function PostFavourScreen() {
  ...
  const handlePost = async () => {
    ...
    if (!title.trim()) {
      Alert.alert(
        "Missing Title",
        "Please enter a title for your favour request.",
      );
      return;
    }
    ...
    if (!description.trim()) {
      Alert.alert(
        "Missing Description",
        "Please enter a description for your favour request.",
      );
      return;
    }
    ...
    if (!type) {
      Alert.alert(
        "Missing Type",
        "Please select a type (Request or Offer) for your favour.",
      );
      return;
    }
    ...
    if (!selectedLocation) {
      Alert.alert(
        "Missing Location",
        "Please set location for your favour request.",
      );
      return;
    }
    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          <Pressable
            style={styles.checkboxRow}
            onPress={() => setHasExpiry((prev) => !prev)}
          >
            <View style={styles.checkbox}>
              {hasExpiry && <View style={styles.checkboxInner} />}
            </View>
            <Text style={styles.checkboxLabel}>Set expiry</Text>
          </Pressable>
